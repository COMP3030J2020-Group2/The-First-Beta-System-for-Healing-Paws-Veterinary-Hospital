...
class Appointment(db.Model):
    ...
    meeting_date = db.Column(db.DateTime,index=True,default=datetime(2020,1,1,0,0,0,0))
    surgery_date = db.Column(db.DateTime,index=True,default=datetime(2020,1,1,0,0,0,0))
